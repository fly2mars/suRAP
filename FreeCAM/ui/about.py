...
class Ui_AboutDialog(object):
    def setupUi(self, AboutDialog):
        ...
        self.label.setGeometry(QtCore.QRect(70, 90, 321, 41))
        font = QtGui.QFont()
        font.setFamily("楷体")
        ...
        self.label_2.setGeometry(QtCore.QRect(140, 120, 101, 41))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(AboutDialog)
        self.label_3.setGeometry(QtCore.QRect(100, 150, 201, 41))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(AboutDialog)
        self.label_4.setGeometry(QtCore.QRect(90, 190, 221, 41))
    ...
    def retranslateUi(self, AboutDialog):
        ...
        self.label.setText(_translate("AboutDialog", "FreeCAM多轴打印系统"))
        self.label_2.setText(_translate("AboutDialog", "Version 1.0"))
        self.label_3.setText(_translate("AboutDialog", "上海大学快速制造工程中心"))
        self.label_4.setText(_translate("AboutDialog", "http://www.rmec.shu.edu.cn"))
